...
public class HitungNilai extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String jumlahHadir = request.getParameter("jumlahHadir");
        String nilaiUTS    = request.getParameter("nilaiUTS");
        String nilaiUAS    = request.getParameter("nilaiUAS");
        String nilaiTugas  = request.getParameter("nilaiTugas");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Rumus: (hadir*0.1) + (tugas*0.2) + (UTS*0.3) + (UAS*0.4)
