...
<%
    String menu = "<br><b>Master Data</b><br>"
            ...
            + "<b>Transaksi</b><br><a href='NilaiController'>Nilai</a><br><br>"
            + "<b>Laporan</b><br><a href='NilaiController?aksi=laporan'>Laporan Nilai</a><br><br>"
            + "<a href='LoginController'>Login</a><br><br>";
    String topMenu = "<nav><ul>"
            + "<li><a href='index.jsp'>Home</a></li>"
            + "<li><a href='#'>Master Data</a><ul><li><a href='MahasiswaController'>Mahasiswa</a></li><li><a href='MataKuliahController'>Mata Kuliah</a></li></ul></li>"
            + "<li><a href='#'>Transaksi</a><ul><li><a href='NilaiController'>Nilai</a></li></ul></li>"
            + "<li><a href='#'>Laporan</a><ul><li><a href='NilaiController?aksi=laporan'>Laporan Nilai</a></li></ul></li>"
            + "<li><a href='LoginController'>Login</a></li></ul></nav>";
...
<title>Informasi Nilai Mahasiswa</title></head>
...
<div id="menu"><%=menu%></div></td>
<td align="center" valign="top" bgcolor="#ffffff"><%=topMenu%><br><%=konten%></td></tr>
